...
- (BOOL)start:(NSError **)errPtr
{
	...
	dispatch_sync(serverQueue, ^{ @autoreleasepool {
		...
		if (success)
		{
            ...
            NSDictionary *serverPort = [[NSDictionary alloc] initWithObjectsAndKeys:[NSString stringWithFormat:@"%hu", [asyncSocket localPort]], @"port",nil];
            [[NSNotificationCenter defaultCenter] postNotificationName:@"HTTPServerStarted" object:self userInfo:serverPort];
			isRunning = YES;
			[self publishBonjour];
		}
		else
