...
@interface BLCurtain2ViewController ()
{
    ...
    Curtain2 *yarnCurtain;
    Curtain2 *clothCurtain;
...
- (void) initPanelView
{
    if (curtainView == nil)
    {
        ...
        curtainView = [[[NSBundle mainBundle] loadNibNamed:@"BLCurtain2PanelView" owner:self options:nil] firstObject];
...
- (void) initCurtainPropertyWithDictionary:(NSMutableDictionary *)curtainPropertyDict buttonName:(NSString *)curtainButtonName
{
    ...
    yarnCurtain = [Curtain2 alloc];
    clothCurtain = [Curtain2 alloc];
